...
🚀 SumTea是一个基于 **组件化+模块化+Kotlin+协程+Flow+Retrofit+Jetpack+MVVM+短视频** 架构实现的 WanAndroid 客户端。 能提供大家学习如何从0到1打造一个符合大型项目的架构模式。大部分使用到 Android Jetpack 中的组件， 项目中提供如何使用和巩固对 [Kotlin+Jetpack+协程](https://juejin.cn/post/7223767530981867557) 等知识的学习，并有详细的注释。能给大家提供一些想法和思考。 项目编码符合符合阿里巴巴 Java 开发规范和阿里巴巴 Android 开发规范。
