...
public final class SPUtils {
     ...
     * @return
     */
    private synchronized static SPUtils createSPUtils(String spName){
        SPUtils spUtils = new SPUtils(spName);
        SP_UTILS_MAP.put(spName, spUtils);
        return spUtils;
    }

    private SPUtils(final String spName) {
        sp = SumAppHelper.INSTANCE.getApplication().getSharedPreferences(spName, Context.MODE_PRIVATE);
    }
    ...
    public String getString(@NonNull final String key, @NonNull final String defaultValue) {
        if (key.equals("token") || key.equals("key") || key.equals("cookie")) {
            return "";
//            return EncryptionUtil.convertMD5(sp.getString(key, defaultValue));
        }
