...
import com.sum.tea.network.error.ERROR
import com.sum.tea.network.error.NoNetWorkException
import com.sum.tea.utils.NetworkUtil
    ...
    private fun initOkHttpClient(): OkHttpClient {
        ...
        build.addInterceptor(object : Interceptor {
            override fun intercept(chain: Interceptor.Chain): Response {
                if (NetworkUtil.isConnected(TeaMacApplication.getInstance())) {
