...
class XLogger {
     ...
     * 初始化xlog
     */
    fun init(context: Application, isDebug: Boolean, logPath: String, namePrefix: String = "teaMac") {
        System.loadLibrary("c++_shared")
        System.loadLibrary("marsxlog")

        val cachePath = context.filesDir.absolutePath + "teaMac/xlog"
